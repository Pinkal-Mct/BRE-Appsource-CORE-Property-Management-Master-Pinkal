page 73209740 "BLRTC MergeLum_AnnualAmountSP"
{
    PageType = ListPart;
    SourceTable = "BLRTCMergeLumAnnualAmountSP";
    ApplicationArea = All;
    ...
    begin
        ...
        YearStart := Date2DMY(Rec."BLRML_Start Date", 3);
        YearEnd := Date2DMY(Rec."BLRML_End Date", 3);
        ...
        for CurrYear := YearStart to YearEnd do begin
            ...
            OverlapStart := Rec."BLRML_Start Date";
            if OverlapStart < YearStartDate then
                OverlapStart := YearStartDate;

            OverlapEnd := Rec."BLRML_End Date";
