...
report 50121 "FS Refundable Payment Receipt"
{
    ...
    DefaultRenderingLayout = "FS Refundable PaymentReceipt.docx";
    ...
    rendering
    {
        layout("FS Refundable PaymentReceipt.docx")
        {
            Type = Word;
            LayoutFile = './FS Refundable PaymentReceipt.docx';
            Caption = 'FS Refundable PaymentReceipt (Word)';
            Summary = 'The FS Refundable PaymentReceipt (Word) provides a simple layout that is also relatively easy for an end-user to modify.';
        }
    }
